...
gmx insert-molecules -f 1OIL_newbox.pdb -ci choline.pdb -nmol 504 -o out.pdb
...
#gmx grompp -f npt_373.mdp -c nvt.gro -r nvt.gro -t nvt.cpt -p topol.top -o npt.tpr
#gmx mdrun -deffnm npt

#gmx grompp -f production_tenth_ns.mdp -c npt.gro -t npt.cpt -p topol.top -o md_0_1.tpr
